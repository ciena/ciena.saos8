...
---
cliconf: saos8
short_description: Use saos8 cliconf to run command on Ciena saos8 platform
description:
  - This saos8 plugin provides low level abstraction apis for
    sending and receiving CLI commands from Ciena saos8 network devices.
"""
...
class Cliconf(CliconfBase):
    def get_device_info(self):
        device_info = {}
        device_info["network_os"] = "ciena.saos8.saos8"
